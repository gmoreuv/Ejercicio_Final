...
\title{Colour me Kubrick\footnote{\url{http://www.visual-memory.co.uk/amk}}}
...
\end{huge}
\begin{abstract}
Este documento tratará sobre\cite{prueba} la inserción de la mayor cantidad posible de comandos en este documento de \LaTeX para ver la destreza del usuario. El contenido mínimo de este documento será de imágenes, listas, ecuaciones y tablas, pero todo nuevo comando será bienvenido.  

El tema elegido para este ejercicio es \textbf{Stanley Kubrick\footnote{\label{note1}\url{https://es.wikipedia.org/wiki/Stanley_Kubrick}}}, el famoso director británico de cine que jamás ganó un \textit{Óscar} al mejor director pese a haber realizado geniales películas.

El crítico de cine y profesor francés Michel Ciment asegura que conoció mucho a Stanley Kubrick, aunque rápidamente señala: 'Bueno, dentro de lo que alguien podía llegar realmente a conocerle. Por lo menos mantuve el contacto con él a lo largo de 30 años'. Kubrick llamaba muy a menudo al director de la revista Positif para hablar de cine, de las películas que había visto en los festivales (y que el realizador de $Espartaco$ se hacía proyectar en su casa) o simplemente para consultarle sobre un buen lugar en París donde poner las vallas publicitarias para la promoción de una determinada película. No obstante, en persona sólo se vieron en cinco ocasiones. La obra Kubrick, considerada ya un clásico sobre uno de los directores de cine más importantes, acaba de llegar a las librerías españolas, editada por \textit{Akal}.\cite{taschen}

Atención, como este es un ejercicio sin ánimo de lucro ninguno, al menos el 95 \% del texto es copiado íntegramente de esta página web\footnote{\ref{note1}}.
\vfill
\end{abstract}
\tableofcontents
\vfill
\section{Biografía del autor\cite{Riambau1990}}
...
\item $\natural$ \textbf{El beso del asesino}
...
\item $\surd$ \textbf{La naranja mecánica}\footnote{\url{http://www.filmaffinity.com/es/film745383.html}}: Gran Bretaña, en un futuro indeterminado. Alex (Malcolm McDowell) es un joven muy agresivo que tiene dos pasiones: la violencia desaforada y Beethoven. Es el jefe de la banda de los drugos, que dan rienda suelta a sus instintos más salvajes apaleando, violando y aterrorizando a la población. Cuando esa escalada de terror llega hasta el asesinato, Alex es detenido y, en prisión, se someterá voluntariamente a una innovadora experiencia de reeducación que pretende anular drásticamente cualquier atisbo de conducta antisocial.
...
\begin{itemize}
	\item Kubrick tocó la batería en el grupo de jazz \textit{Taft Swing Band}.
	\item Una de sus grandes pasiones desde niño era el ajedrez. Soñaba con poder jugar contra una máquina. En la película  \textit{Odisea 2001}, uno de los astronautas juega al ajedrez con \textit{HAL 9000}. En esta web se puede ver la partida completa:
	
	$http://pasionporelajedrez.blogspot.com.es/2007/02/la-partida-de-2001-odisea-del-espacio.html$ 
	
	\item El nombre de HAL 9000 viene de  \textit{Heuristically Programmed Algorithmic Computer}, es decir, \textit{ordenador algorítmico heurísticamente programado}. Muchas personas comprendieron en seguida que HAL eran las letras anteriores a IBM en lo que parecía un guiño a la marca.
Sin embargo, el escritor Arthur C. Clarke, creador junto a Kubrik de la obra, lo negó.
	\item Sus dos primeras películas, \textit{Miedo y deseo} y \textit{El beso del asesino}, que rodó con dinero prestado de sus familiares, le llevaron a la ruina.
	\item El actor \textit{Malcom McDowell}, después de la escena en que le aplican la terapia agresiva a Alex, contó que \textit{nunca pudo volver a usar colirio}. Dice que le causan \textit{fobia} y que pasó varios días con problemas graves en los ojos por los que pensó que se quedaría ciego. 
	\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{naranja}
	\caption{Malcom McDowell en La Naranja Mecánica}
	\end{figure}
	\item Durante el rodaje de \textit{El resplandor}, Kubrick llamó a Stephen King a las 3 de la mañana para preguntarle si creía en Dios.
	\item Sobre la muerte de Kubrick, \textit{Nicole Kidman} dijo en una entrevista en 2002 que el director ``no murió por voluntad propia$"$ y que habló con ella 2 horas antes de que muriera en su casa para decirle esta frase: ``Nos van a envenenar a todos tan rápidamente que no nos dará tiempo ni a estornudar$"$.
	\item ``La Naranja mecánica$?$ es, junto con ``Cowboy de medianoche$"$, el único film calificado X que ha optado al Oscar a la Mejor Película.
	\item La famosa escena de ``Heeeere?s Johnny$?$ tuvo que ser repetida, a instancias del director, en 157 ocasiones. Se entiende la cara de loco de \textit{Jack Nicholson}.
	\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{resplandor}
	\caption{Una de las 157 tomas que se rodaron de esta escena.}
	\end{figure}
	\item La alfombra de la casa de \textit{Sid} en la película de animación ``Toy Story$"$ tiene el mismo diseño de la alfombra del Hotel Overlook en ``El Resplandor$"$.
	\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{alfombra}
	\caption{Comparación de alfombras en \textit{Toy Story} y \textit{El Resplandor}}
	\end{figure}
\end{itemize}
\newpage
\begin{figure}[htb]
\centering
\subfigure[Fotos de Kubrick de joven]{\includegraphics[width=0.40\textwidth]{stan}}
\subfigure[Foto de Kubrick de mayor]{\includegraphics[width=0.40\textwidth]
{stan2}}
\caption{Stanley Kubrick} \label{fotos}
\end{figure}
\begin{landscape} 
\begin{tabular}{|c|p{4cm}|c|c|p{6cm}|c|c|}
\hline 
Año & Película & Nominación Óscar & \includegraphics[width=22mm]{Oscar_imagen} & \centering Notas & Presupuesto & IMDB \\ 
\hline 
...
Stanley Kubrick dice adios desde estas fotos(vínculo a las fotos anteriores): 
\begin{huge}
\ref{fotos}
\end{huge}
...
\section{Factura por informe realizado.} 

\begin{figure}[H]
	\includegraphics[width=1.2\textwidth]{Factura_Curso_Git_Latex}	
\end{figure}
